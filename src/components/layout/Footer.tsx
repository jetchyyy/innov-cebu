...
import { Zap, MapPin, Phone, Mail, Share2, Users, Globe } from 'lucide-react';
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-light/70 text-sm">123 Industrial Tech Park, Mandaue City, Cebu, Philippines 6014</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="text-primary w-5 h-5 shrink-0" />
                <span className="text-light/70 text-sm">+63 (32) 123 4567</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="text-primary w-5 h-5 shrink-0" />
                <span className="text-light/70 text-sm">info@innovcebu.com.ph</span>
              </li>
            </ul>
          </div>
        </div>
